...
public class ProductDao {
    ...
    public void addProduct(Product product, int userId) throws Exception {
        String insertStatement = "INSERT INTO product (name, description, seller_id, unit_price, quantity, image_path, "
    ...
    public List<Product> getProductListBySellerId(int sellerId) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Product product = new Product(id, name, description, quantity, unitPrice, imageName);
    ...
    public Product getProduct(int productId) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                float unitPrice = rs.getFloat("unit_price");
                String imageName = rs.getString("image_path");
                product = new Product(id, name, description, quantity, unitPrice, imageName);
